...
#   1. Request/validate an ACM cert in us-east-1 for the domain, e.g. axeng.example.com
#   2. Run with:
#      ALIASES=axeng.example.com CERT_ARN=arn:aws:acm:us-east-1:... ./scripts/deploy-aws-cloudfront.sh
