...
import {
  Grid2X2, List, GitBranch, MessageSquare, Clock
} from 'lucide-react'

const teamMembers = [
  { id: '1', name: 'Pedro Ferreira', role: 'Backend Engineer', email: 'user.f@example.com', status: 'active', github: 'pedroferreira-orbit', linear: 'pedro.ferreira', avatar: 'PF', skills: ['Python', 'FastAPI', 'PostgreSQL'], activeProjects: ['Orbit', 'Compass'], openIssues: 12, prsOpen: 3, lastActivity: '2026-05-10T09:15:00' },
  { id: '2', name: 'Diogo Oliveira', role: 'DevOps / Infra', email: 'user.e@example.com', status: 'active', github: 'DiogoAntunesOliveira', linear: 'diogo.oliveira', avatar: 'DO', skills: ['Kubernetes', 'Terraform', 'AWS'], activeProjects: ['Heimdall', 'Orbit'], openIssues: 8, prsOpen: 2, lastActivity: '2026-05-10T08:50:00' },
  ...
  { id: '4', name: 'João FCSantos', role: 'Engineering', email: 'user.c@example.com', status: 'ooo', github: 'jfcsantos', linear: 'joao.fcsantos', avatar: 'JF', skills: ['Python', 'ML', 'Data'], activeProjects: ['Brain', 'Sagittarius'], openIssues: 15, prsOpen: 1, lastActivity: '2026-05-09T17:00:00', oooUntil: '2026-05-16' },
  { id: '5', name: 'Rikkarth R.', role: 'ML / AI Engineer', email: 'user.g@example.com', status: 'active', github: 'rikkarth', linear: 'rikkarth', avatar: 'RR', skills: ['PyTorch', 'MLOps', 'LLMs'], activeProjects: ['Brain', 'Sagittarius', 'WareAI'], openIssues: 9, prsOpen: 2, lastActivity: '2026-05-10T09:00:00' },
  { id: '6', name: 'Daniel Almeida', role: 'CEO', email: 'user.a@example.com', status: 'active', github: '', linear: 'daniel.almeida', avatar: 'DA', skills: ['Leadership', 'Product'], activeProjects: [], openIssues: 3, prsOpen: 0, lastActivity: '2026-05-10T08:00:00' },
  { id: '7', name: 'Luis Santos', role: 'Co-founder', email: 'user.b@example.com', status: 'active', github: '', linear: 'luis.santos', avatar: 'LS', skills: ['Strategy', 'Growth'], activeProjects: [], openIssues: 2, prsOpen: 0, lastActivity: '2026-05-10T09:45:00' },
]
