      ...
      <section className="mx-auto max-w-5xl px-5 py-24 text-center sm:px-8">
        <div className="rounded-[2rem] border border-cyan-300/20 bg-cyan-300/[0.06] px-6 py-12 shadow-[0_0_80px_rgba(34,211,238,0.12)]">
          ...
          <div className="mt-8 flex justify-center">
            <a href="mailto:hello@example.com" className="inline-flex items-center justify-center gap-2 rounded-full bg-cyan-200 px-6 py-3 text-sm font-semibold text-slate-950 transition hover:bg-cyan-100">
